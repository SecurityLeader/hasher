...
__Code__ = python
__Github__ = https://github.com/SecurityLeader
__Date__ = 6 ~ 4 ~ 2023
__Team__ = Black Army
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" Mr.Robot "+W+"Xnver404"+Y+"                 |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" leaderhacking123@gmail.com"+Y+"                   |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/SecurityLeader"+Y+"           |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 6 - 04 - 2023"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+" Black Army"+Y+"                   |")
	print (Y+" 0{===================================================}0\n")
